...
硬件—SaaS—Codex 连接软件。当前公开版本：Apple 芯片 Mac v0.3.4；云端已部署，完整新 Mac/真机演示仍待现场验收。
...
当前发布入口：[v0.3.4 新 Mac 快速开始](docs/v0.3/NEW-MAC-QUICKSTART.md)，完整话术见 [演示操作手册](docs/v0.3/DEMO-OPERATIONS.md)。
