...
export interface QwenAsrOptions{apiKey:string;model?:string;baseURL:string;fetchFn?:typeof fetch;pollIntervalMs?:number;maxPolls?:number;requestTimeoutMs?:number}
