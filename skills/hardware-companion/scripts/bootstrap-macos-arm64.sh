...
release_url='https://github.com/gamecncom/codex-hardware-companion/releases/download/v0.3.3/hardware-companion-macos-arm64-v0.3.3.tar.gz'
checksum_url="$release_url.sha256"
work="$(mktemp -d "${TMPDIR:-/tmp}/hardware-companion.XXXXXX")"; trap 'rm -rf "$work"' EXIT INT TERM
archive="$work/hardware-companion-macos-arm64-v0.3.3.tar.gz"
